...
WANDB_DIR = "wandb_logs_16_doub"
BEST_MODEL_DIR = "best_model_16_doub.pth"
VIDEO_ROOT = ""
LABEL_ROOT = ""
        ...
        for video_dir in video_dirs:
            ...
            for frame_idx in range(len(labels)):
                ...
                if os.path.exists(img_path):
                    # 拆分标签：前7维是状态，后3维是任务one-hot
                    state_label = np.concatenate([labels[frame_idx][:7], labels[frame_idx][10:16]])

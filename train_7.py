...
def main():
    ...
    # 创建数据集
    video_root = '/Users/zhongyeah/Documents/Research/Ban/model/data/video'  # 替换为实际路径
    label_root = '/Users/zhongyeah/Documents/Research/Ban/model/data/label'  # 替换为实际路径
